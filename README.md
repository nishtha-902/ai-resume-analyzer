...
Built an AI-powered Resume Analyzer with React, React Router, and Puter.js! Implemented seamless upload and store resumes, and match candidates to jobs using smart AI evaluations. Get custom feedback and ATS scores tailored to each listing—all wrapped in a clean, reusable UI.
...
```bash
git clone https://github.com/nishtha-902/ai-resume-analyzer.git
